import { Container, Square ,Circle, 
    SubContainer, HeadContainer,
     Line,SubHeadContainer, MainContainer,StatusActivity} from "./indexStyle";


const CardHabitsHome = () =>{
    return (
        <MainContainer>
        <h2>Tenha o controle em suas mãos criando seus
        próprios hábitos e classificando-os de acordo com seu nivel de dificuldade.  
        </h2>
        <Container>
